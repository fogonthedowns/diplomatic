...
func (g *Game) BuildGameBoard() {
	var gb = GameBoard{
		...
		LONDON:    GameSquareData{Owner: ENGLAND, Units: []Unit{{UnitType: ARMY, Owner: ENGLAND}}},
		...
		VENICE:   GameSquareData{Owner: ITALY},
		TUSCANY:  GameSquareData{Owner: ITALY},
		ROME:     GameSquareData{Owner: ITALY},
